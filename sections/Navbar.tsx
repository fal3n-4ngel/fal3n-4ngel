...
export const Navbar = () => {
  return (
    <motion.nav
      ...
      className={`md:py-12" fixed left-0 right-0 top-0 z-50 w-full py-8 transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)]`}
    >
      <div
        className={`"w-full } mx-auto flex max-w-7xl items-center justify-between border border-transparent bg-transparent px-12 py-8 transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)]`}
      >
        <Link
          href="/"
