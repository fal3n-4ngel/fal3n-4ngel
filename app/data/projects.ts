...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: "A Next.js web platform featuring an AI image generator with custom-trained Stable Diffusion model and arcade games. Built with Firebase and EpicRealism image model, it evolved from a DBMS course project into a playground for implementing advanced web technologies.",
  },
  {
    url1: "/Tuples.png",
    name: "Tuples",
    ...
    description: "A community platform designed exclusively for students at MBCET. It enables users to find friend matches based on shared interests, create and join projects, and engage in collaborative chats and topic-based community groups. Created as a B.Tech mini project.",
  },
  {
    url1: "/SOYO.png",
  ...
  },
  {
    ...
    description: "A blockchain-based certification platform that uniquely identifies organizations through secure wallet IDs and authenticates users via AADHAR integration, ensuring tamper-proof documentation. This project secured the winning spot at BlockHash 2023 by the Kerala Blockchain Academy.",
  },
  {
  ...
  },
  {
    ...
    description: "A college project centered on promoting sustainable development goals (SDGs). SUS Goals provides users with daily tasks to complete and maintains a global counter of completed tasks, helping SDGs through an engaging digital experience.",
  },
  {
    url1: "/Drish.png",
    name: "DRISHTI",
