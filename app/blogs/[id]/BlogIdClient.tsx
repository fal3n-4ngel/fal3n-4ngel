...
export default function BlogIdClient({
  ...
  return (
    <div className="h-full min-h-screen w-full bg-black text-white" ref={ref}>
      ...
      <main className="mx-auto max-w-3xl px-12 pt-48 pb-24 selection:bg-white selection:text-black">
        {/* Breadcrumb Navigation */}
        <FadeUp>
          <Link
            href="/blogs"
            className="interactable group inline-flex items-center gap-2 font-mono text-xs uppercase tracking-widest text-neutral-500 transition-all hover:gap-3 hover:text-white"
          >
        ...
        <FadeUp>
          <div className="mt-12 space-y-6 border-b border-white/10 pb-8">
            <h1 className="space-grotesk text-3xl font-light leading-tight tracking-tight text-white md:text-5xl lg:text-6xl">
              {blog.title}
            </h1>
