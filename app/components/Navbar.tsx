...
function Navbar() {
  return (
    <nav className="flex w-full md:w-[90vw]  items-center justify-between pt-5 py-2 mb-10 px-[10px] mx-auto z-[1]   overflow-hidden bg-[#ececec]  dark:bg-[#121212]  md:bg-transparent md:dark:bg-transparent">
