        ...
        <div className="flex flex-col lg:w-1/2 gap-14 sm:gap-18 md:gap-20 w-full min-w-0">
          {filteredProjects.map((project, idx) => {
            ...
            return (
              ...
              >
                {/* Top Meta Bar */}
                <div className="flex flex-wrap items-center justify-between border-b border-white/10 pb-3 mb-5 font-mono text-[11px] sm:text-xs text-zinc-500 uppercase tracking-widest gap-2">
                ...
                <div className="flex flex-col sm:flex-row sm:items-baseline justify-between gap-3 mb-5">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl font-light uppercase tracking-tight text-white leading-tight">
                    <a
                ...
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 pt-5 sm:pt-6 border-t border-white/5 mt-5 sm:mt-6">
                  {/* Description */}
                  {project.description && (
                  ...
                  <div className="flex flex-wrap items-center gap-2 shrink-0">
                    {skills.slice(0, 4).map((skill) => (
                      <span
                        key={skill}
                        className="px-2 py-0.5 font-mono text-[10px] sm:text-[11px] uppercase tracking-wider text-zinc-400 border border-white/10 bg-white/[0.02]"
                      >
                        {skill}
                      </span>
                    ))}
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="ml-auto lg:ml-3 inline-flex items-center gap-1 font-mono text-xs text-white hover:text-zinc-300 transition-colors py-0.5"
                    >
                      <span>[ View ↗ ]</span>
                    </a>
                  </div>
